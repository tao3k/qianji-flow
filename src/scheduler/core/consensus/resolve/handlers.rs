...
use super::types::{ConsensusCheckpointView, ConsensusOutcome, EXTERNAL_PROGRESS_TIMEOUT_MS};
use crate::consensus::{ConsensusManager, ConsensusResult};
use crate::contracts::NodeStatus;
use crate::error::QianjiError;
use tokio::time::Duration;

impl QianjiScheduler {
    pub(super) async fn resolve_consensus_output(
        &self,
